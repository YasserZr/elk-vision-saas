...
urlpatterns = [
    ...
    # Admin routes
    path('admin/profile/<int:user_id>/', UserProfileAdminView.as_view(), name='admin-user-profile'),
    path('admin/initialize-indexes/', InitializeIndexesView.as_view(), name='initialize-indexes'),
]

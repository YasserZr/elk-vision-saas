...
from app.core.redis_cache import SessionCache, QueryCache
...
class UserProfileCreateView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.info(f"Created profile for user {request.user.id}, tenant {tenant_id}")
...
class UserProfileAdminView(APIView):
    ...
    def delete(self, request, user_id):
        ...
        try:
            ...
            logger.info(f"Deleted profile for user {user_id} by admin {request.user.id}")

...
class LogParser:
    ...
    @staticmethod
    def parse(content: str, format_type: str, metadata: Dict[str, Any]) -> List[Dict[str, Any]]:
...
class JSONLogParser:
    ...
    @staticmethod
    def _enrich_entry(entry: Dict[str, Any], metadata: Dict[str, Any]) -> Dict[str, Any]:
        """Enrich log entry with metadata"""
        enriched = {
            '@timestamp': entry.get('timestamp') or entry.get('@timestamp') or datetime.utcnow().isoformat(),
...
class CSVLogParser:
    ...
    @staticmethod
    def _process_row(row: Dict[str, str], metadata: Dict[str, Any], row_num: int) -> Dict[str, Any]:
        """Process CSV row into log entry"""
        
        # Try to find timestamp field
        timestamp = None
        for possible_ts_field in ['timestamp', 'time', 'datetime', 'date', '@timestamp']:
...
class TextLogParser:
    ...
    @staticmethod
    def _parse_line(line: str, metadata: Dict[str, Any], line_num: int) -> Dict[str, Any]:

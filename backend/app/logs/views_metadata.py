...
class LogMetadataListView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to retrieve metadata", "message": str(e)},
...
class LogMetadataDetailView(APIView):
    ...
    def delete(self, request, upload_id):
        ...
        try:
            ...
            return Response(
                {"message": "Metadata deleted successfully"}, status=status.HTTP_200_OK
            )

        except Exception as e:
            logger.error(f"Error deleting metadata: {e}", exc_info=True)
            return Response(
                {"error": "Failed to delete metadata", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class LogMetadataStatsView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response(
                {"error": "Failed to retrieve statistics", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class LogMetadataRecentView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response(
                {"recent_uploads": results, "count": len(results)},
                status=status.HTTP_200_OK,
            )
            ...
            return Response(
                {"error": "Failed to retrieve recent uploads", "message": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )

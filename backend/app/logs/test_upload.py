...
2025-11-24T10:02:00Z,WARNING,Test warning,worker"""
        ...
        file = SimpleUploadedFile(
            "test_logs.csv", csv_content.encode("utf-8"), content_type="text/csv"
        )

        response = self.client.post(
            "/api/v1/logs/upload/", {"file": file}, format="multipart"
        )
...
2025-11-24 10:02:00 - app - INFO - Retry successful"""
        ...
        file = SimpleUploadedFile(
            "test_logs.log", text_content.encode("utf-8"), content_type="text/plain"
        )
    ...
    def test_upload_without_authentication(self):
        ...
        file = SimpleUploadedFile(
            "test.json", b'{"test": "data"}', content_type="application/json"
        )
    ...
    def test_upload_empty_file(self):
        ...
        file = SimpleUploadedFile("empty.json", b"", content_type="application/json")
    ...
    def test_upload_oversized_file(self):
        ...
        file = SimpleUploadedFile(
            "large.json", large_content.encode("utf-8"), content_type="application/json"
        )
    ...
    def test_upload_invalid_extension(self):
        ...
        file = SimpleUploadedFile(
            "test.exe", b"some binary data", content_type="application/octet-stream"
        )
    ...
    def test_upload_invalid_json(self):
        ...
        file = SimpleUploadedFile(
            "invalid.json", b"{invalid json content", content_type="application/json"
        )
...
class LogSearchTestCase(TestCase):
    ...
    def test_search_logs(self):
        ...
        response = self.client.get(
            "/api/v1/logs/search/", {"q": "error", "level": "ERROR"}
        )

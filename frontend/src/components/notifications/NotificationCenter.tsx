...
export default function NotificationCenter({
  ...
  const { isConnected, notifications, clearNotifications } = useNotifications(
    useCallback((notification: Notification) => {
      // Create toast for new notifications
  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        {/* Notification Panel */}
        {isPanelOpen && (
          <div className="absolute right-0 mt-2 w-96 max-h-[600px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
            {/* Header */}
